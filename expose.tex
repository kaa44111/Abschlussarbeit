...
\newacronym{knn}{KNNs}{Künstlichen Neuronalen Netzen}
...
\pagestyle{headings} % Seitennummern und Kapitelbezeichnungen anzeigen
    ...
    \include{expose/1-Einleitung}
    %\include{expose/2-ElevatorPitch}
    \include{expose/3-Zielsetzung}
    \include{expose/4-Methodik}
    \include{expose/5-Gliederung}
    \include{expose/6-Ablauf}
